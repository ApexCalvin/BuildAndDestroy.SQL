...
, ('Calvin Tran', '57 Union St', 'Arlington', 'G13RB', 'Scotland');

INSERT INTO Students (studentName, address, city, postalCode, country)
VALUES('Nina Chen', '57 Union St', 'Philadelphia', 'G13RB', 'Scotland')
,('Collin Cleveland', '57 Union St', 'Trenton', 'G13RB', 'Scotland')
,('Anna Fu', '57 Union St', 'Edinburgh', 'G13RB', 'Japan')
,('Freddy Mintarja', '57 Union St', 'Edinburgh', 'Null', 'Japan')
,('Carolina D', '57 Union St', 'Edinburgh', '', 'Japan');

INSERT INTO Students (studentName, address, city, country)
VALUE('Yingjie', '57 Union St', 'Edinburgh', 'Japan');
